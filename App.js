...
import { generateReadingMaterial } from './services/genAI.js';
import { ReadingView } from './components/ReadingView.js';
import { BreakGame } from './components/BreakGame.js';
...
export default function App() {
  ...
  const startReadingSession = async (level) => {
    setLoading(true);
  ...
  const handleReadingComplete = (wpm, accuracy) => {
    // Award XP
